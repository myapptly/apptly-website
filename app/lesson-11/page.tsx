export default function Lesson11() {
  ...
  <h2 className="text-2xl font-bold text-white mb-4">
    And Maybe A Few More Tools You Might Use
  </h2>
...
<p className="text-gray-300 leading-relaxed">
  A safe way to accept payments in your app — credit cards, subscriptions, one-time purchases. You only need this if your app charges money for something. It's free to set up and only takes a small fee when you make a sale.
</p>         
</div> 
