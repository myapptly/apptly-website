...
<div className="mt-10 rounded-2xl border border-[#00FF94]/30 bg-white/5 p-8">
  ...
  <p className="mt-4 text-gray-300">
    ...
    <br /><br />
    Throughout this course, you'll build right alongside me. You'll see the prompts I used, the mistakes I made, and how I fixed them.
    <br /><br />
...
<div className="my-10"> 
        ...
        <div className="my-10">
  <img
    src="/create accounts.png"
    alt="Create Your Accounts"
