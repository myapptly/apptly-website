    ...
    <section className="relative bg-[#0D0F0C] text-[#EDE9E2] min-h-screen px-6 py-20">
      <div className="max-w-2xl mx-auto flex flex-col items-center text-center gap-6">
        ...
        <div className="mb-2 flex justify-center">
          <Image alt="APPTLY Logo" className="h-auto w-auto max-w-[420px] sm:w-[500px]" height={500} priority src="/apptly real logo.png" width={420}/>
        </div>

        {/* Badge */}
        <span className="text-xs font-mono font-semibold tracking-widest uppercase bg-[#39FF8C]/10 text-[#39FF8C] border border-[#39FF8C]/20 px-3 py-1 rounded-full">
          Partner Network
        </span>
