...
const plans = [
  {
    ...
    price: "$4.97",
    period: "/month",
    description: "Perfect for your first AI-built app",
    features: [
      "Beginner friendly lessons",
      "AI app building basics",
      "Community access",
      "14-day free trial",
    ],
  ...
  {
    name: "Builder (Most Popular)",
    emoji: "🟡",
    price: "$9.97",
    period: "/month",
    description: "Build, launch, and grow with confidence",
    features: [
      "All launch features",
      "Templates and examples",
      "Growth and monetization lessons",
      "Build your first profitable app",
      "14-day free trial",
    ],
  ...
  },
  {
    ...
    price: "$14.97",
    period: "/month",
    description: "Build, launch, and scale your AI app business",
    features: [
      "Everything in Builder",
      "Clone the APPTLY App",
      "Live Q&A sessions",
